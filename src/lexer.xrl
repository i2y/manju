...
TRUE = True
FALSE = False
DOT_NAME_LPAREN = \.[_a-zA-Z$][-_a-zA-Z0-9?!]*\(
DOT_NAME = \.[_a-zA-Z$][-_a-zA-Z0-9?!]*
DOT_DOT = \.\.
SELF_DOT = self\.
DOT = \.
...
{DOT_NAME_LPAREN} : {token, {dot_name_lparen, TokenLine, tl(lists:reverse(tl(lists:reverse(TokenChars))))}}.
{DOT_NAME} : {token, {dot_name, TokenLine, tl(TokenChars)}}.
